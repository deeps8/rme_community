          ...
          <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="discussion">
              ...
              <div class="head-of-discussion p-2">
                <div class="row">
                  ...
                  <div class="col-10 heading-time">
                    ...
                    <h5>Looking for options for investment in Chennai</h5>
                    <div class="dsc-status">
                      <span>2 Replies</span><b> |</b>
                      <span>30+ Views</span><b> | </b>
                      <span>Last Reply: 20 jun 2018 </span><b> | </b>
                      <span>Posted on: 12 jan 2018</span>
                    </div>
                    <div class="discussion-info">
                      <p>
                        Interested land owners, consultants, and other stakeholders may show their interest below
												so that we all can create our own local community.
                      </p>
                    </div>
                  </div>
              ...
              <div style="padding: 0 9%" class="pb-4 dsc-status">
                ...
                <span class="mr-3" style="font-size: 17px"><button><i class="far fa-thumbs-up"></i></button> 33</span><b> | </b>
                <span class="ml-3" style="font-size: 17px"><button><i class="far fa-thumbs-down"></i></button> 5</span>
              </div>
            </div>
            ...
            <!-- discussion replies (one "row" one reply) -->
              <div class="replies">
                <div class="filter">
                  <h6 class="d-inline">Replies : 2</h6>
                ...
                <div class="row">
                  ...
                  <div class="col-10 reply-text">
                    <div class="text-right text-secondary font-weight-bold">31 mar 2018</div>
                    <p>
                      Being a developer having experience of  both this platform and real estate in Chennai, I would be glad
											to be a part of the community you are creating and contribute my part towards your deal and its after usage.
                    </p>
                ...
                <div class="row">
                  ...
                  <div class="col-10 reply-text">
                    <div class="text-right text-secondary font-weight-bold">2 april 2018</div>
                    <p>
                        Hello! I am an established broker in Chennai and well acquainted with this RME platform for Real Estate
												I would love to join your community for helping you to get the best of deals in terms of facilities,
