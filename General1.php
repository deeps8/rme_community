          ...
          <div class="col-lg-6 col-md-6 col-sm-12 " >
            ...
            <div class="discussion">
              ...
              <div style="padding: 0 9%" class="pb-4 dsc-status">
                ...
                <span class="mr-3" style="font-size: 17px"><button><i class="far fa-thumbs-up"></i></button> 12</span><b> | </b>
                <span class="ml-3" style="font-size: 17px"><button><i class="far fa-thumbs-down"></i></button> 12</span>
              </div>
            </div>
